...
import { IconCopy, IconPlus, IconSetting } from '@douyinfe/semi-icons';
...
function CodeHelp() {
    ...
    return (
        ...
        >
            ...
            <Paragraph>这是一个代码剪贴板，你可以在此存储一些代码片段，并方便地拷贝它们。</Paragraph>
            ...
            <Paragraph>所有的代码数据都在浏览器中，没有一个字节会被上传至网络。</Paragraph>
            <Paragraph>试着按下【F12】，切换到【应用程序】-&gt;【本地存储】，它们就在那里，一个也不少。</Paragraph>
            <Title heading={5} style={{ margin: '8px 0' }}>
                为什么存储上限是5MB？
            </Title>
            <Paragraph>这是浏览器对于本地存储的限制，未来可能会引入indexedDB以打破这一限制。</Paragraph>
            <Paragraph>在设置菜单里你可以找到测试最大存储容量的选项，其原理是不断尝试存储字符串直至报错。</Paragraph>
            {/* <Title heading={5} style={{ margin: "8px 0" }}>
        数据如何迁移？
      </Title>
