...
function CodeOS() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', margin: '8px' }}>
            ...
            <Text link={{ href: 'https://github.com/reduxjs/react-redux' }}>React Redux</Text>
            ...
            <Text link={{ href: 'https://github.com/sudodoki/copy-to-clipboard' }}>copy-to-clipboard</Text>
            ...
            <Text link={{ href: 'https://github.com/JetBrains/JetBrainsMono' }}>JetBrainsMono</Text>
